= A blog, the fun way
:page-layout: article
:page-description: Creating a blog using Hugo, Docker, and Netlify with AsciiDoc support
:page-revdate: 2019-08-18
...
Whilst VS Code and Docker aren't strictly necessary, I've been itching to use the https://code.visualstudio.com/docs/remote/containers[Container Development] feature of VS Code. +
